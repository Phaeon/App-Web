...
let btn_convocations = document.querySelector('td.convocations');
...
let convocations = document.querySelector('#convocations');
...
btn_convocations.addEventListener("click",page_convocations);
