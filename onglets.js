...
function page_accueil()
{
	...
	page.open("GET","accueil.html",true);
	page.send();
}
...
function page_convocations()
{
	...
	page.open("GET","convocations.html",true);
	page.send();
}
...
function page_absences()
{
	...
	page.open("GET","absences.html",true);
	page.send();
}
...
function page_calendrier()
{
	...
	page.open("GET","calendrier.html",true);
	page.send();
}
...
function page_effectif()
{
	...
	page.open("GET","effectif.html",true);
	page.send();
}
